...
export const updateLucrareSiRecalculeaza = adapter.updateLucrareSiRecalculeaza
export const deleteLucrare = adapter.deleteLucrare
export const numaraLucrariSiDevize = adapter.numaraLucrariSiDevize
export const stergeToateLucrarile = adapter.stergeToateLucrarile
export const getExtraUri = adapter.getExtraUri
export const addExtra = adapter.addExtra
export const updateExtra = adapter.updateExtra
...
export const setFinalizareEtapa = adapter.setFinalizareEtapa
export const getSalariulMeu = adapter.getSalariulMeu
export const getTehnicieniCuCont = adapter.getTehnicieniCuCont
export const creeazaContTehnician = adapter.creeazaContTehnician
...
export const getDevize = adapter.getDevize
export const getDevizLucrari = adapter.getDevizLucrari
export const getLucrareIdsFacturate = adapter.getLucrareIdsFacturate
export const creeazaDeviz = adapter.creeazaDeviz
export const deleteDeviz = adapter.deleteDeviz
